...
Context context;
ArrayList<DataMovie.Results> movie;

public MovieAdapter(Context context, ArrayList<DataMovie.Results> movie) {
    ...
    final DataMovie.Results movieI = movie.get(position);
